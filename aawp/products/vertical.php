...
<div class="<?php echo $this->get_product_container_classes('aawp-product aawp-product--vertical'); ?>" <?php $this->the_product_container(); ?>>
    ...
    <div class="aawp-product__image--link aawp-product__image" style="background-image: url('<?php echo $this->get_product_image('large'); ?>');">
    ...
    <div class="aawp-product__footer">
        ...
        <div class="aawp-product__pricing">
	        ...
	        <div class="compare-price">
		        ...
		        ?>
		        <div class="compare-price-partner compare-amazon">
