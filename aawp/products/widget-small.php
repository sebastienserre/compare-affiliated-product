...
<div class="<?php echo $this->get_product_container_classes( 'aawp-product aawp-product--widget-small' ); ?>" <?php $this->the_product_container(); ?>>
	...
	<span class="aawp-product__inner">
        <div class="aawp-product__image-link aawp-product__image"
             style="background-image: url('<?php echo $this->get_product_image( 'medium' ); ?>');"></div>
        <span class="aawp-product__content">
            <a class="aawp-product__title" href="<?php echo $this->get_product_url(); ?>"
               title="<?php echo $this->get_product_link_title(); ?>" rel="nofollow"
               target="_blank"><?php echo $this->truncate( $this->get_product_title(), 50 ); ?></a>
